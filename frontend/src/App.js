...
import {
  Home, Wallet, ArrowDownCircle, ArrowUpCircle, ShoppingCart, BarChart3, Users, User, LogOut,
...
const SumberJayaApp = () => {
  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 relative bg-slate-900 overflow-hidden font-sans">
        {/* Background photo with subtle transparency */}
        <div
        ...
        {/* Animated Glowing Ring from Reference */}
        <AnimatedCircleBars />
          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full text-xs text-left">
              <thead className="bg-gray-50/80 border-b border-gray-100 text-[10px] uppercase tracking-wider text-gray-500 font-bold">
                <tr>
                  <th className="px-2.5 py-2.5 w-[90px]">Tanggal</th>
                  <th className="px-2.5 py-2.5 w-[50px]">PT</th>
                  <th className="px-2.5 py-2.5 w-[100px]">Kategori</th>
                  <th className="px-2.5 py-2.5 min-w-[200px]">Keterangan</th>
                  <th className="px-2.5 py-2.5 text-right w-[100px]">Masuk</th>
                  <th className="px-2.5 py-2.5 text-right w-[100px]">Keluar</th>
                  <th className="px-2.5 py-2.5 text-right w-[110px]">Saldo</th>
                  <th className="px-2.5 py-2.5 text-center no-print w-[85px]">Status</th>
                  <th className="px-2.5 py-2.5 text-center no-print w-[75px]">Aksi</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                <tr className="bg-blue-50/50 border-b border-blue-100 font-medium">
                  <td colSpan="6" className="px-2.5 py-2 text-center text-blue-800 font-semibold">
                    Saldo Awal {filterKasKecil.tanggalMulai ? `(Sebelum ${new Date(filterKasKecil.tanggalMulai).toLocaleDateString('id-ID')})` : ''}
                  </td>
                  <td className="px-2.5 py-2 text-right font-bold text-blue-700 whitespace-nowrap">
                    Rp {formatRupiah(saldoAwal)}
                  </td>
                  <td colSpan="2" className="px-2.5 py-2 no-print"></td>
                </tr>
                {dataWithBalance.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="px-2.5 py-2 text-gray-700 break-words leading-relaxed max-w-[300px]">{item.keterangan}</td>
              ...
              <tfoot className="bg-gray-50/80 border-t-2 border-gray-200">
                <tr>
                  <td colSpan="4" className="px-2.5 py-2.5 text-right font-bold text-gray-700">Total Hari Ini (Approved)</td>
                  <td className="px-2.5 py-2.5 text-right font-black text-emerald-600">Rp {formatRupiah(masuk)}</td>
                  <td className="px-2.5 py-2.5 text-right font-black text-rose-600">Rp {formatRupiah(keluar)}</td>
                  <td colSpan="3" className="px-2.5 py-2.5"></td>
                </tr>
                <tr className="bg-blue-50/50">
                  <td colSpan="4" className="px-2.5 py-2.5 text-right font-bold text-gray-700">Saldo Akhir</td>
                  <td colSpan="5" className="px-2.5 py-2.5 text-right font-black text-blue-700 text-base">
                    Rp {formatRupiah(saldo)}
                  </td>
                </tr>
              </tfoot>
